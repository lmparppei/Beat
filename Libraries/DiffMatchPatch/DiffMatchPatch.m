 ...
 * ARC conversion: l-m@parppei.com (Lauri-Matti Parppei)
 */

/*
 
 This version has been converted to support ARC in modern systems.
 It was a low-effort job and might have unexpected consequences, as
 I'm not a real programmer and just did things I learned from stackoverflow.
 
 Mainly, the CGStringRefs and NSString typecasts have been bridged and
 retains & releases removed.
